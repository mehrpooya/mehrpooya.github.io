  ...
  projects: [
...

   {
      ...
      content: [
       ...
       { type: "links", items: [
            { label: "GitHub Repository", href: "https://github.com/mehrpooya/zcu102-usb-gadget-platform" },
            { label: "Read the Docs", href: "https://zcu102-usb-gadget-platform.readthedocs.io/en/latest/index.html" }
        ]},
